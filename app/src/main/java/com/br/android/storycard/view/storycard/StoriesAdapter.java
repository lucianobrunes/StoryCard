...
public class StoriesAdapter extends RecyclerView.Adapter<StoriesAdapter.ViewHolder> {
    ...
    // interface implemented by StoriesFragment to respond
...
/*            itemView.setOnClickListener(
                    new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            clickListener.onClick(DatabaseDescription.Story.buildStoryUri(rowID));
                        }
                    }
            );*/
        }
    ...
    public final StoryClickListener clickListener;

    // constructor
    public StoriesAdapter(StoryClickListener clickListener) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.setRowID(cursor.getLong(cursor.getColumnIndex(DatabaseDescription.Story._ID)));
        holder.textView.setText(cursor.getString(cursor.getColumnIndex(
                DatabaseDescription.Story.COLUMN_TITULO)));
    }
